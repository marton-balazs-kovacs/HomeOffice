...
The distinct values of survey progress are `r raw %>% count(progress)`.
...
There are `r nrow(raw)` response left after excluding the non finished responses.
...
Based on agreement amng MK. and BA. where respondents provided free text responses we will use the "Other" label in tha analysis. Detailed responses will be available in the openly shared dataset. 
